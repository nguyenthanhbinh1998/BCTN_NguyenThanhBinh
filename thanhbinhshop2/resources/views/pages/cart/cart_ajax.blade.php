					...
					<tbody>
						...
						<tr>
							...
							<td>
                                 ...
                                 ?>
                                  <li><a href="{{URL::to('/checkout')}}"><i class="btn-dark"></i> Đặt hàng</a></li>
                                
                                <?php
                                 }elseif($customer_id!=NULL && $shipping_id!=NULL){
                                 ?>
                                 <li><a href="{{URL::to('/payment')}}"><i class="btn-dark"></i> Đặt hàng</a></li>
                                 <?php 
                                }else{
                                ?>
                                 <li><a href="{{URL::to('/dang-nhap')}}"><i class="btn-dark"></i> Đặt hàng</a></li>
                                <?php
                                 }
                                ?>
							</td>
